...
export const UI_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  "Explore our curated collection of recipes organized by category. Find the perfect dish for any occasion.": { ar: "استكشف مجموعتنا المختارة من الوصفات المنظمة حسب الفئة. اعثر على الطبق المثالي لأي مناسبة.", zh: "探索我们按类别整理的精选食谱集合。为任何场合找到完美的菜肴。", ja: "カテゴリー別に整理された厳選レシピコレクションをご覧ください。あらゆる機会に最適な料理を見つけましょう。", de: "Entdecken Sie unsere kuratierte Rezeptsammlung nach Kategorien. Finden Sie das perfekte Gericht für jeden Anlass.", nl: "Verken onze samengestelde collectie recepten per categorie. Vind het perfecte gerecht voor elke gelegenheid.", es: "Explora nuestra colección curada de recetas organizadas por categoría. Encuentra el plato perfecto para cualquier ocasión.", it: "Esplora la nostra collezione curata di ricette organizzate per categoria. Trova il piatto perfetto per ogni occasione.", ru: "Изучите нашу подборку рецептов по категориям. Найдите идеальное блюдо для любого случая." },
  "Search categories...": { ar: "ابحث في الفئات...", zh: "搜索分类...", ja: "カテゴリーを検索...", de: "Kategorien suchen...", nl: "Categorieën zoeken...", es: "Buscar categorías...", it: "Cerca categorie...", ru: "Поиск категорий..." },
  "Loading categories...": { ar: "جاري تحميل الفئات...", zh: "正在加载分类...", ja: "カテゴリーを読み込み中...", de: "Kategorien werden geladen...", nl: "Categorieën laden...", es: "Cargando categorías...", it: "Caricamento categorie...", ru: "Загрузка категорий..." },
  "No categories found matching": { ar: "لم يتم العثور على فئات تطابق", zh: "未找到匹配的分类", ja: "一致するカテゴリーが見つかりません", de: "Keine passenden Kategorien gefunden", nl: "Geen overeenkomende categorieën gevonden", es: "No se encontraron categorías que coincidan", it: "Nessuna categoria trovata corrispondente", ru: "Категории не найдены" },
  "Loading recipes...": { ar: "جاري تحميل الوصفات...", zh: "正在加载食谱...", ja: "レシピを読み込み中...", de: "Rezepte werden geladen...", nl: "Recepten laden...", es: "Cargando recetas...", it: "Caricamento ricette...", ru: "Загрузка рецептов..." },
  "No recipes in this category yet.": { ar: "لا توجد وصفات في هذه الفئة بعد.", zh: "此分类暂无食谱。", ja: "このカテゴリーにはまだレシピがありません。", de: "Noch keine Rezepte in dieser Kategorie.", nl: "Nog geen recepten in deze categorie.", es: "Aún no hay recetas en esta categoría.", it: "Ancora nessuna ricetta in questa categoria.", ru: "В этой категории пока нет рецептов." },
  "Be the first to create one!": { ar: "كن أول من يصنع واحدة!", zh: "成为第一个创建的人！", ja: "最初に作成しましょう！", de: "Sei der Erste, der eines erstellt!", nl: "Wees de eerste die er een maakt!", es: "¡Sé el primero en crear una!", it: "Sii il primo a crearne una!", ru: "Будьте первым, кто создаст!" },
  "Failed to load categories": { ar: "فشل تحميل الفئات", zh: "加载分类失败", ja: "カテゴリーの読み込みに失敗しました", de: "Kategorien konnten nicht geladen werden", nl: "Categorieën laden mislukt", es: "Error al cargar categorías", it: "Caricamento categorie fallito", ru: "Не удалось загрузить категории" },
