              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-2">Share your ideas and suggestions</p>
                    <a href="mailto:feedback@flavorai.com" className="text-primary hover:underline text-sm">
