          ...
          <Card className="shadow-card mb-12">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                FlavorAI was created to make cooking more accessible, creative, and enjoyable for
                everyone. Whether you're a seasoned chef or just starting your culinary journey,
                our AI-powered platform helps you discover new recipes tailored to your unique
                preferences.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                We believe that great cooking should be accessible to everyone, regardless of
                experience level or available ingredients. That's why we've built a platform that
                combines the power of artificial intelligence with the art of cooking.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Google Gemini AI:</strong> Powers our recipe and image generation with
                ...
                <li className="flex items-start gap-2">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span>
                    <strong>Lovable Cloud:</strong> Provides secure backend infrastructure for data
                ...
                <li className="flex items-start gap-2">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span>
                    <strong>React & TypeScript:</strong> Ensures a fast, responsive, and type-safe
                    user experience
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span>
                    <strong>Tailwind CSS:</strong> Creates beautiful, consistent designs that work
                    on any device
                  </span>
                </li>
              </ul>
